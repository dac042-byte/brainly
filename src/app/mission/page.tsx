        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-slate-850/80 backdrop-blur-xl rounded-2xl border border-slate-750/50 p-8">
            <div className="space-y-4 text-slate-300 leading-relaxed text-[15px]">
              ...
              <p>
                Cogna measures three key areas of cognitive performance: reaction time, speech processing, and memory recall. Together, these give you a snapshot of how your brain is functioning. Track your performance over time. Compare yourself to your baseline, notice trends, and make decisions based off your own data.
              </p>
              ...
              <p className="text-sm text-slate-400 italic pt-4 border-t border-slate-750/50 mt-6">
                This is not a medical device. Cogna is a self-tracking tool for personal awareness. Always consult medical professionals for health decisions.
              </p>
            </div>
          </div>
        </div>
