    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <div className="flex justify-center">
          <Link
            href="/signup"
            className="bg-gradient-to-r from-rose-400 to-pink-400 text-white px-8 py-3 rounded-lg font-semibold hover:opacity-90 transition"
          >
            Start Free
          </Link>
        </div>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold mb-3 text-rose-400">Reaction Time Test</h3>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold mb-3 text-rose-400">Speech Analysis</h3>
            <p className="text-white">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold mb-3 text-rose-400">Memory Tracking</h3>
            <p className="text-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="flex gap-4 items-start">
              <div className="flex-shrink-0 w-8 h-8 bg-rose-400 text-white rounded-full flex items-center justify-center font-bold">✓</div>
              <div>
                <h3 className="font-bold mb-2 text-white">Early Detection of Cognitive Changes</h3>
                <p className="text-white">
            ...
            <div className="flex gap-4 items-start">
              <div className="flex-shrink-0 w-8 h-8 bg-rose-400 text-white rounded-full flex items-center justify-center font-bold">✓</div>
              <div>
                <h3 className="font-bold mb-2 text-white">Monitor Brain Health Over Time</h3>
                <p className="text-white">
            ...
            <div className="flex gap-4 items-start">
              <div className="flex-shrink-0 w-8 h-8 bg-rose-400 text-white rounded-full flex items-center justify-center font-bold">✓</div>
              <div>
                <h3 className="font-bold mb-2 text-white">Private & Secure Brain Assessment</h3>
                <p className="text-white">
            ...
            <div className="flex gap-4 items-start">
              <div className="flex-shrink-0 w-8 h-8 bg-rose-400 text-white rounded-full flex items-center justify-center font-bold">✓</div>
              <div>
                <h3 className="font-bold mb-2 text-white">Science-Based Cognitive Testing</h3>
                <p className="text-white">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          <div className="flex gap-6 items-start">
            <div className="flex-shrink-0 w-12 h-12 bg-rose-400 text-white rounded-full flex items-center justify-center text-xl font-bold">1</div>
            <div>
          ...
          <div className="flex gap-6 items-start">
            <div className="flex-shrink-0 w-12 h-12 bg-rose-400 text-white rounded-full flex items-center justify-center text-xl font-bold">2</div>
            <div>
          ...
          <div className="flex gap-6 items-start">
            <div className="flex-shrink-0 w-12 h-12 bg-rose-400 text-white rounded-full flex items-center justify-center text-xl font-bold">3</div>
            <div>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-rose-400 to-pink-400 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            href="/signup"
            className="bg-white text-rose-400 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition inline-block"
          >
            Get Started Free
          </Link>
        </div>
