        ...
        <form onSubmit={handleReset} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-900/50 border border-slate-750 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-rose-600 focus:border-transparent transition-all"
              required
            />
          </div>
